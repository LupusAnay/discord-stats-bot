...
data Lane = Mid | Middle | Top | Jungle | Bot | Bottom
data Role = Duo | None | Solo | DuoCarry | DuoSupport
...
data Tier = Challenger | Master | Diamond | Platinum | Gold | Silver | Bronze | Unranked
...
--retrieveMatchData :: UserID -> IO Match
--retrieveMatchData userID =